    ...
    <div class="row">
        ...
        <div class="col-md-6 hotel-single mt-4 mb-5 ftco-animate">
            ...
            <div class="form-group">
                ...
                <span style="color: red;" id="passengerPrice">Passenger Price: AED{{ $packages->price }}</span>
            </div>
            <div class="form-group">
            ...
            <br>
            <input type="button" id="bookOnlineButton" value="Book Online" class="btn btn-primary">
</div>
        ...
        <div class="col-md-6 ftco-animate">
            ...
            <div id="contactFormSection" class="col-md-6 ftco-animate" style="display: none;">
    <h3>Contact Us</h3>
