            ...
            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                <div class="destination">
                    <a href="#" class="img img-2 d-flex justify-content-center align-items-center"
                        style="background-image: url('{{ asset('storage/' . $flight->image_path) }}');">
                    ...
                    <div class="text p-3 d-flex flex-column">
                        <div class="one">
                            ...
                            <h6 style="max-width: 300px; overflow-wrap: break-word;">
                                <a href="#">{{ $flight->description }}</a>
                            </h6>
                        </div>
                        <div class="form-group mt-auto">
                            <form action="{{ route('show_flights', ['id' => $flight->id]) }}" method="get">
                                @csrf
                                <span class="price">
                                    <del>AED250</del> AED{{ $flight->price }}
                                </span>
